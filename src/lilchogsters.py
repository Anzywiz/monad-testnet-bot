    ...
    async def mint(self) -> bool:
        ...
        for retry in range(ATTEMPTS):
            try:
                ...
                print_step('balance',
                           f"Current NFT balance: {Fore.CYAN}{balance} / Target: {random_amount}{Style.RESET_ALL}")
                ...
                if receipt["status"] == 1:
                    print_step('mint',
                               f"{Fore.GREEN}✔ Successfully minted! TX: {EXPLORER_URL}{tx_hash.hex()}{Style.RESET_ALL}")
